package com.damon.example.thread.Semaphore;
...
public class PrintQueue2 {
    ...
    //1.  如我们之前提到的，你将实现semaphores来修改print queue例子。
    // 打开PrintQueue类并声明一个boolean array名为 freePrinters。
    // 这个array储存空闲的等待打印任务的和正在打印文档的printers。
    ...
    //3.   修改类的构造函数并初始化新声明的对象们。freePrinters array 有3个元素，
    // 全部初始为真值。semaphore用3作为它的初始值。
    public PrintQueue2() {
