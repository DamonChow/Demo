...
public class RemoteTest {
    ...
    public void testService() {
        ...
        NDC.push("555--");
        logger.info("result=" + helloWorldService.sayHelloTwo("damon", "chow"));
        NDC.pop();
        NDC.push("555--");
        logger.info("result=", helloWorldService.insertPerson(genPerson()));
        NDC.pop();
        NDC.push("666--");
        HelloWorldTwoService helloWorldTwoService = context.getBean("helloWorldTwoService", HelloWorldTwoService.class);
        logger.info("result=" + helloWorldTwoService.sayHello("damon"));
        NDC.pop();
        NDC.push("333--");
        logger.info("result=" + helloWorldService.sayHello("damon"));
        logger.info("end.........");
        NDC.pop();
    }
